...
<?php 
  ...
  if (!isset($_POST['submit']))  {
    ...
    echo " ";
      ...
      $status = $_POST['status'];
      $sql = "INSERT INTO coverage_areas (`location_name`, `status`) VALUES ('$location_name', '$status')";
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST">
                  <div class="form-group">
                    ...
                    <input type="text" name="location_name" class="form-control" id="form-control-2" placeholder="Loaction Name" data-error="Please enter Location Name" required>
